                        ...
                        <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="row mb-4">
                                <div class="col-sm-12 col-md-6">
                                    <a href="{{ route('admin.users.create') }}" class="btn btn-primary btn-sm">Tambah Akun</a>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>{{ $admins->email }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.users.edit', $admins->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                                        <form action="{{ route('admin.users.destroy', $admins->id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
